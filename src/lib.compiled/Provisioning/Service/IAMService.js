...
var IAMService = (function (_AbstractService) {
  _inherits(IAMService, _AbstractService);
  ...
  function IAMService() {
    ...
    _get(Object.getPrototypeOf(IAMService.prototype), 'constructor', this).apply(this, args);
  }
  ...
  _createClass(IAMService, [{
    key: 'name',
    value: function name() {
      return _mitocgroupDeepCore2['default'].AWS.Service.IDENTITY_AND_ACCESS_MANAGEMENT;
    }
