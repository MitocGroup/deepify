...
var MissingOptionException = (function (_ValidationException) {
  _inherits(MissingOptionException, _ValidationException);

  /**
   * @param {Option} option
   */

  function MissingOptionException(option) {
    _classCallCheck(this, MissingOptionException);
    ...
    _get(Object.getPrototypeOf(MissingOptionException.prototype), 'constructor', this).call(this, 'The option \'--' + option.name + '\' ' + aliasPlain + ' is missing');
  }
