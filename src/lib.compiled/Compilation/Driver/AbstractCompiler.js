...
var AbstractCompiler = (function (_Core$OOP$Interface) {
  _inherits(AbstractCompiler, _Core$OOP$Interface);

  function AbstractCompiler() {
    _classCallCheck(this, AbstractCompiler);

    _get(Object.getPrototypeOf(AbstractCompiler.prototype), 'constructor', this).call(this, ['compile']);
  }
